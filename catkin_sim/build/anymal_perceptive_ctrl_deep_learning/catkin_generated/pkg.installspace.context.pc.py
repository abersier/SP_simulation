...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "${prefix}/include;/opt/ros/noetic/include;/opt/openrobots/lib/pkgconfig/../../include;/usr/include/eigen3".split(';') if "${prefix}/include;/opt/ros/noetic/include;/opt/openrobots/lib/pkgconfig/../../include;/usr/include/eigen3" != "" else []
