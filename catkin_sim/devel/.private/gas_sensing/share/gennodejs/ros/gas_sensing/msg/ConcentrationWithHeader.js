...
class ConcentrationWithHeader {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ConcentrationWithHeader(null);
  ...
  static datatype() {
    ...
    return 'gas_sensing/ConcentrationWithHeader';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ConcentrationWithHeader(null);
...
module.exports = ConcentrationWithHeader;
