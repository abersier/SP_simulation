...
class FloatWithHeader {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FloatWithHeader(null);
  ...
  static datatype() {
    ...
    return 'esp32_ros/FloatWithHeader';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FloatWithHeader(null);
...
module.exports = FloatWithHeader;
