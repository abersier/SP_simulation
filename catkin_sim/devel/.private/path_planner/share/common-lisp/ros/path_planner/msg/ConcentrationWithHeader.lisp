...
(cl:defmethod cl:initialize-instance :after ((m <ConcentrationWithHeader>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConcentrationWithHeader)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name path_planner-msg:<ConcentrationWithHeader> is deprecated: use path_planner-msg:ConcentrationWithHeader instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ConcentrationWithHeader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader path_planner-msg:header-val is deprecated.  Use path_planner-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'concentration-val :lambda-list '(m))
(cl:defmethod concentration-val ((m <ConcentrationWithHeader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader path_planner-msg:concentration-val is deprecated.  Use path_planner-msg:concentration instead.")
  (concentration m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <ConcentrationWithHeader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader path_planner-msg:pose-val is deprecated.  Use path_planner-msg:pose instead.")
  (pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConcentrationWithHeader>)))
  ...
  "path_planner/ConcentrationWithHeader")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConcentrationWithHeader)))
  "Returns string type for a message object of type 'ConcentrationWithHeader"
  "path_planner/ConcentrationWithHeader")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ConcentrationWithHeader>)))
  ...
  "1afbe5b0dba4403221876028b40c67fa")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ConcentrationWithHeader)))
  "Returns md5sum for a message object of type 'ConcentrationWithHeader"
  "1afbe5b0dba4403221876028b40c67fa")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ConcentrationWithHeader>)))
  ...
  (cl:format cl:nil "# ConcentrationWithHeader.msg~%std_msgs/Header header~%float32 concentration~%geometry_msgs/PoseStamped pose~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/PoseStamped~%# A Pose with reference coordinate frame and timestamp~%Header header~%Pose pose~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ConcentrationWithHeader)))
  "Returns full string definition for message of type 'ConcentrationWithHeader"
  (cl:format cl:nil "# ConcentrationWithHeader.msg~%std_msgs/Header header~%float32 concentration~%geometry_msgs/PoseStamped pose~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/PoseStamped~%# A Pose with reference coordinate frame and timestamp~%Header header~%Pose pose~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
